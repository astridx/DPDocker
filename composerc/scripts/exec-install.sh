...
echo "START--------------/home/astrid/DP/DPDocker/composerc/scripts/exec-install.sh----------START"
...
if [ ! -d /usr/src/Projects/DPDocker/composerc/tmp ]; then
  mkdir /usr/src/Projects/DPDocker/composerc/tmp
fi

ln -s /usr/src/Projects/DPDocker/composerc/tmp /home/docker/.composer
...
echo "ENDE--------------/home/astrid/DP/DPDocker/composerc/scripts/exec-install.sh----------ENDE"
